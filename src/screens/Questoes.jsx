...
export default function Questoes({navigation}) {
  ...
  const {q1, setQ1, q2, setQ2, q3, setQ3, q4, setQ4, q5, setQ5, q6, setQ6, q7, setQ7, q8, setQ8, q9, setQ9, q10, setQ10} = useContext(QuestoesContext);

  function validarQuestoes() {
    let ok = true;
    if (q1 < 0) {
      Alert.alert("É necessário responder a questão 1!!!")
      ok = false;
    } 
    if (q2 < 0) {
      Alert.alert("É necessário responder a questão 2!!!")
      ok = false;
    }
  ...
  return (
    <ScrollView>
      ...
      <View>
        <Text>Questão4 - Qual é, em média, a quantidade de frutas que você consome por dia?</Text>
        <View row align="center" spacing={4}>
          <CheckBox
      ...
      <View>
        <Text>Questão5 - O que você leva de lanche para a escola/trabalho?
        </Text>
        <View row align="center" spacing={4}>
          <CheckBox
        ...
        <View>
        <Text>Questão6 - Você consome algum tipo de verdura ou legume todos os 
dias?</Text>
        <View row align="center" spacing={4}>
          <CheckBox 
      ...
      <View>
        <Text>Questão7 - Quantas vezes por semana você come carne vermelha?</Text>
        <View row align="center" spacing={4}>
          <CheckBox
            title="Todos os dias"
            checked={q7 === 1}
      ...
      <View>
        <Text>Questão8 - Quantas vezes por semana você pratica atividades 
físicas?</Text>
        <View row align="center" spacing={4}>
          <CheckBox
            title=" Todos os dias"
      ...
      <View>
        <Text>Questão9 - Qual tipo de gordura é mais utilizado na sua casa para 
cozinhar os alimentos?</Text>
        <View row align="center" spacing={4}>
          <CheckBox
          ...
          />
          <CheckBox
            title="Óleos vegetais (óleo de soja, girassol, algodão, 
              canola)"
            checked={q9 === 3}
            onPress={() => setQ9(3)}
            checkedIcon="dot-circle-o"
      ...
      <View>
        <Text>Questão10 - Você costuma tomar refrigerantes com qual frequência?</Text>
        <View row align="center" spacing={4}>
          <CheckBox
